# ============================================================
# scheduler.py — 일정 및 리마인더 관리 시스템
# ============================================================
# 역할: 자연어로 일정 추가/조회/삭제/완료 처리.
#       JSON 파일(schedules.json)에 영구 저장.
#
# 자연어 파싱: "내일 오후 3시 회의" → datetime + 제목 추출
# 리마인더: check_reminders()로 N분 전 알림 확인
# 시간 표현: 오전/오후, 오늘/내일/모레, N시 N분 지원
# ============================================================
import logging
import json
