...
# ============================================================
# 역할: 대화 텍스트에서 키워드 기반으로 감정을 분석하고,
#       감정에 대응하는 LED 색상/패턴 및 서보 동작을 결정.
#       ESP32에 전송할 EMOTION 명령 JSON을 생성.
#
# 지원 감정: happy, sad, excited, sleepy, angry, neutral
# 감정 전이: 새 감정 감지 시 자동 전환, 시간 경과 시 neutral로 회귀
# ============================================================
import logging
import random
